...
## Notes
- `Static` file contains text noise
- `cat ltdis.sh` displays following :
```#!/bin/bash
...
- It states about `objdump` command <br>
You can find more about it [here](https://man7.org/linux/man-pages/man1/objdump.1.html)
...
- This will create a file `static.ltdis.x86_64.txt` and `static.ltdis.strings.txt`
- `static.ltdis.x86_64.txt` Displays the assembler mnemonics for the machine instructions from the input file.
- `static.ltdis.strings.txt` Displays any strings found in static
